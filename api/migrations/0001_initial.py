# Generated by Django 3.0.5 on 2020-11-04 19:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Простой пользователь'), ('moderator', 'Пользователь для модерации'), ('admin', 'Администратор сайта')], default='user', max_length=128)),
